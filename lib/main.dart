...
const String _imageUrlTwo = 'https://static.pexels.com/photos/163065/mobile-phone-android-apps-phone-163065.jpeg';
...
const List<Photo> photos = <Photo>[
  const Photo(index: 0, title: const Text('ImagenUno'), url: _imageUrlOne, icon: const Icon(Icons.looks_one)),
  const Photo(index: 1, title: const Text('ImagenDos'), url: _imageUrlTwo, icon: const Icon(Icons.looks_two)),
  const Photo(index: 2, title: const Text('ImagenTres'), url: _imageUrlThree, icon: const Icon(Icons.looks_3)),
];
...
class LoadImageState extends State<LoadImage> with SingleTickerProviderStateMixin {
